...
namespace FRDDYL002 {
    ...
    private:
        ...
        unsigned char* buffer;    // Buffer to hold image data in 1D array
        ...
        void floodFill(int x, int y, int label, ConnectedComponent& comp, vector<bool>& visited, unsigned char threshold);
    ...
    public:
        ...
        */
        ...
        void setPrintStatus(bool printData);

        /* print the data for a component to std::cout
        see ConnectedComponent class;
        print out to std::cout: component ID, number of pixels
        */
        void printComponentData(const shared_ptr<ConnectedComponent> & theComponent) const;
    };
